...
function FranchisePage() {
  ...
  const handleFranchiseChange = (
    ...
    setFranchiseForm({ ...franchiseForm, [e.target.name]: e.target.value });
  };

  const handleFranchiseSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = encodeURIComponent('Franchise Inquiry - SandhyaSolar Website');
